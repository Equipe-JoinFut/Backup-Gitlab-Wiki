...
[$`{\color{black}\boxed{\color{darkgreen}\mathbb{Página \space Inicial \space do \space BACKEND}}}`$](backend/backend_home)

[$`{\color{black}\boxed{\color{darkblue}\mathbb{Página \space Inicial \space do \space FRONTEND}}}`$](frontend/frontend_home)

[$`{\color{black}\boxed{\color{darkorange}\mathbb{Página \space Inicial \space do \space DATABASE}}}`$](database/database_home)
